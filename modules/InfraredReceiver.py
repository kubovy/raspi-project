    ...
    def perform(self, action):
        ...
        if action == "MOVE_FORWARD":
            if self.wheels is not None:
                self.wheels.move(self.speed, self.speed, 0.5)
            ...
            if self.wheels is not None:
                self.wheels.move(self.speed, -self.speed, 0.1)
            self.last_action = action
            ...
            if self.wheels is not None:
                self.wheels.move(self.speed, 0, 0.25)
            self.last_action = action
        elif action == "TURN_RIGHT":
            if self.wheels is not None:
                self.wheels.move(0, self.speed, 0.25)
            self.last_action = action
            ...
            if self.pixels is not None:
                self.pixels.notify([[[255, 0, 0], [0, 0, 0], [0, 0, 0], [255, 0, 0]]], [1])
            self.last_action = action
